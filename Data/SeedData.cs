...
namespace MusicSystem.Data
{
    public static class SeedData
    {
        public async static Task Initialize (IServiceProvider serviceProvider)
        {
            ...
            PlaylistSong ps2 = new PlaylistSong(new DateTime(2023, 02, 28, 13, 00, 00), song2, playlist2);
            song2.PlaylistSongs.Add(ps2);
            playlist2.PlaylistSongs.Add(ps2);
            PlaylistSong ps3 = new PlaylistSong(new DateTime(2023, 02, 28, 00, 30, 00), song3, playlist3);
            song3.PlaylistSongs.Add(ps3);
            playlist3.PlaylistSongs.Add(ps3);
            PlaylistSong ps4 = new PlaylistSong(new DateTime(2023, 02, 28, 22, 00, 00), song4, playlist1);
            song4.PlaylistSongs.Add(ps4);
            playlist1.PlaylistSongs.Add(ps4);
            PlaylistSong ps5 = new PlaylistSong(new DateTime(2023, 02, 28, 12, 04, 00), song5, playlist2);
            song5.PlaylistSongs.Add(ps5);
            playlist2.PlaylistSongs.Add(ps5);
            PlaylistSong ps6 = new PlaylistSong(new DateTime(2023, 02, 28, 10, 16, 00), song6, playlist3);
            song6.PlaylistSongs.Add(ps6);
            playlist3.PlaylistSongs.Add(ps6);
            PlaylistSong ps7 = new PlaylistSong(new DateTime(2023, 02, 28, 11, 16, 00), song6, playlist1);
            song6.PlaylistSongs.Add(ps7);
            playlist1.PlaylistSongs.Add(ps7);
            ...
            PlaylistSong ps9 = new PlaylistSong(new DateTime(2023, 02, 28, 00, 00, 28), song8, playlist3);
            song8.PlaylistSongs.Add(ps9);
            playlist3.PlaylistSongs.Add(ps9);
            PlaylistSong ps10 = new PlaylistSong(new DateTime(2023, 03, 01, 09, 10, 00), song9, playlist1);
            song9.PlaylistSongs.Add(ps10);
            playlist1.PlaylistSongs.Add(ps10);
            PlaylistSong ps11 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 06, 00), song10, playlist2);
            song10.PlaylistSongs.Add(ps11);
            playlist2.PlaylistSongs.Add(ps11);
            PlaylistSong ps12 = new PlaylistSong(new DateTime(2023, 03, 01, 03, 50, 00), song11, playlist3);
            song11.PlaylistSongs.Add(ps12);
            playlist3.PlaylistSongs.Add(ps12);
            PlaylistSong ps13 = new PlaylistSong(new DateTime(2023, 03, 01, 04, 44, 00), song12, playlist1);
            song12.PlaylistSongs.Add(ps13);
            playlist1.PlaylistSongs.Add(ps13);
            PlaylistSong ps14 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 30, 00), song13, playlist2);
            song13.PlaylistSongs.Add(ps14);
            playlist2.PlaylistSongs.Add(ps14);
            PlaylistSong ps15 = new PlaylistSong(new DateTime(2023, 03, 01, 01, 40, 00), song13, playlist3);
            song13.PlaylistSongs.Add(ps15);
            playlist3.PlaylistSongs.Add(ps15);
            PlaylistSong ps16 = new PlaylistSong(new DateTime(2023, 03, 01, 20, 00, 00), song14, playlist1);
            song14.PlaylistSongs.Add(ps16);
            playlist1.PlaylistSongs.Add(ps16);
            PlaylistSong ps17 = new PlaylistSong(new DateTime(2023, 03, 01, 07, 18, 59), song15, playlist2);
            song15.PlaylistSongs.Add(ps17);
            playlist2.PlaylistSongs.Add(ps17);
            PlaylistSong ps18 = new PlaylistSong(new DateTime(2023, 03, 01, 09, 00, 00), song16, playlist3);
            song16.PlaylistSongs.Add(ps18);
            playlist3.PlaylistSongs.Add(ps18);
            PlaylistSong ps19 = new PlaylistSong(new DateTime(2023, 03, 01, 10, 12, 00), song16, playlist1);
            song16.PlaylistSongs.Add(ps19);
            playlist1.PlaylistSongs.Add(ps19);
            PlaylistSong ps20 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 00, 00), song17, playlist2);
            song17.PlaylistSongs.Add(ps20);
            playlist2.PlaylistSongs.Add(ps20);
            PlaylistSong ps21 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 00, 30), song18, playlist3);
            song18.PlaylistSongs.Add(ps21);
            playlist3.PlaylistSongs.Add(ps21);
            PlaylistSong ps22 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 20, 00), song19, playlist1);
            song19.PlaylistSongs.Add(ps22);
            playlist1.PlaylistSongs.Add(ps22);
            PlaylistSong ps23 = new PlaylistSong(new DateTime(2023, 03, 01, 11, 42, 00), song20, playlist2);
            song20.PlaylistSongs.Add(ps23);
            playlist2.PlaylistSongs.Add(ps23);
            PlaylistSong ps24 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 06, 00), song21, playlist3);
            song21.PlaylistSongs.Add(ps24);
            playlist3.PlaylistSongs.Add(ps24);
            PlaylistSong ps25 = new PlaylistSong(new DateTime(2023, 03, 01, 05, 00, 00), song22, playlist1);
            song22.PlaylistSongs.Add(ps25);
            playlist1.PlaylistSongs.Add(ps25);
            PlaylistSong ps26 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 29, 00), song23, playlist2);
            song23.PlaylistSongs.Add(ps26);
            playlist2.PlaylistSongs.Add(ps26);
            PlaylistSong ps27 = new PlaylistSong(new DateTime(2023, 03, 01, 22, 00, 00), song24, playlist3);
            song24.PlaylistSongs.Add(ps27);
            playlist3.PlaylistSongs.Add(ps27);
            PlaylistSong ps28 = new PlaylistSong(new DateTime(2023, 03, 01, 02, 00, 00), song25, playlist1);
            song25.PlaylistSongs.Add(ps28);
            playlist1.PlaylistSongs.Add(ps28);
            PlaylistSong ps29 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 22, 00), song26, playlist2);
            song26.PlaylistSongs.Add(ps29);
            playlist2.PlaylistSongs.Add(ps29);
            PlaylistSong ps30 = new PlaylistSong(new DateTime(2023, 03, 01, 00, 00, 33), song27, playlist1);
            song27.PlaylistSongs.Add(ps30);
            playlist1.PlaylistSongs.Add(ps30);
            PlaylistSong ps31 = new PlaylistSong(new DateTime(2023, 03, 01, 01, 00, 00), song28, playlist3);
            song28.PlaylistSongs.Add(ps31);
            playlist3.PlaylistSongs.Add(ps31);
            PlaylistSong ps32 = new PlaylistSong(new DateTime(2023, 03, 01, 03, 00, 00), song29, playlist1);
            song29.PlaylistSongs.Add(ps32);
            playlist1.PlaylistSongs.Add(ps32);
            PlaylistSong ps33 = new PlaylistSong(new DateTime(2023, 03, 01, 16, 38, 02), song30, playlist2);
            song30.PlaylistSongs.Add(ps33);
            playlist2.PlaylistSongs.Add(ps33);
            ...
            context.PlaylistSong.Add(ps14);
            context.PlaylistSong.Add(ps15);
            context.PlaylistSong.Add(ps16);
            context.PlaylistSong.Add(ps17);
            context.PlaylistSong.Add(ps18);
            context.PlaylistSong.Add(ps19);
            context.PlaylistSong.Add(ps20);
            context.PlaylistSong.Add(ps21);
            context.PlaylistSong.Add(ps22);
            context.PlaylistSong.Add(ps23);
            context.PlaylistSong.Add(ps24);
            context.PlaylistSong.Add(ps25);
            context.PlaylistSong.Add(ps26);
            context.PlaylistSong.Add(ps27);
            context.PlaylistSong.Add(ps28);
            context.PlaylistSong.Add(ps29);
            context.PlaylistSong.Add(ps30);
            context.PlaylistSong.Add(ps31);
            context.PlaylistSong.Add(ps32);
            context.PlaylistSong.Add(ps33);
